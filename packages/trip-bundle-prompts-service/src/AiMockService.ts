...
// Helper functions to generate ISO date strings
  ...
  const allMockBundles: TripBundle[] = [
    {
      ...
      keyEvents: [
        ...
        },
        {
          ...
          interestType: "concerts",
          dateRange: {
            startDate: getDateString(34),
            endDate: getDateString(34)
          },
      ...
      minorEvents: [
        {
          ...
          dateRange: {
            startDate: getDateString(41),
            endDate: getDateString(44)
          },
    ...
    },
    {
      ...
      city: "Paris, France",
      dateRange: {
        startDate: getDateString(50),
        endDate: getDateString(55)
      },
      keyEvents: [
        {
      ...
      minorEvents: [
        {
          ...
          interestType: "artDesign",
          dateRange: {
            startDate: getDateString(47),
            endDate: getDateString(120)
          }
          // No eventWebsite for this one (testing optional field)
        },
        {
    ...
    },
    {
      ...
      keyEvents: [
        ...
        },
        {
          ...
          interestType: "artDesign",
          dateRange: {
            startDate: getDateString(71),
            endDate: getDateString(71)
          },
      ...
      minorEvents: [
        {
          ...
          interestType: "localCulture",
          dateRange: {
            startDate: getDateString(72),
            endDate: getDateString(72)
          }
        },
        {
          ...
          interestType: "culinary",
          dateRange: {
            startDate: getDateString(73),
            endDate: getDateString(73)
          },
    ...
    },
    {
      ...
      dateRange: {
        startDate: getDateString(80),
        endDate: getDateString(85)
      },
      keyEvents: [
        {
          ...
          interestType: "concerts",
          dateRange: {
            startDate: getDateString(81),
            endDate: getDateString(81)
          },
        ...
        },
        {
          ...
          interestType: "concerts",
          dateRange: {
            startDate: getDateString(82),
            endDate: getDateString(82)
          }
        }
      ],
      minorEvents: [
        {
          ...
          interestType: "artDesign",
          dateRange: {
            startDate: getDateString(83),
            endDate: getDateString(83)
          },
        ...
        },
        {
          ...
          interestType: "localCulture",
          dateRange: {
            startDate: getDateString(84),
            endDate: getDateString(84)
          }
        }
      ]
    },
      ...
      keyEvents: [
        {
          ...
          interestType: "localCulture",
          dateRange: {
            startDate: getDateString(91),
            endDate: getDateString(91)
          },
        ...
        },
        {
          ...
          interestType: "artDesign",
          dateRange: {
            startDate: getDateString(92),
            endDate: getDateString(92)
          }
        }
      ],
      minorEvents: [
        {
          ...
          interestType: "culinary",
          dateRange: {
            startDate: getDateString(93),
            endDate: getDateString(93)
          },
        ...
        },
        {
          ...
          interestType: "culinary",
          dateRange: {
            startDate: getDateString(94),
            endDate: getDateString(94)
          }
        }
      ]
    },
      ...
      keyEvents: [
        {
          ...
          interestType: "concerts",
          dateRange: {
            startDate: getDateString(101),
            endDate: getDateString(101)
          },
        ...
        },
        {
          ...
          interestType: "artDesign",
          dateRange: {
            startDate: getDateString(102),
            endDate: getDateString(102)
          }
        }
      ],
      minorEvents: [
        {
          ...
          interestType: "localCulture",
          dateRange: {
            startDate: getDateString(103),
            endDate: getDateString(103)
          },
    ...
    },
    {
      ...
      dateRange: {
        startDate: getDateString(110),
        endDate: getDateString(115)
      },
      keyEvents: [
        {
          ...
          interestType: "culinary",
          dateRange: {
            startDate: getDateString(111),
            endDate: getDateString(111)
          },
        ...
        },
        {
          ...
          interestType: "artDesign",
          dateRange: {
            startDate: getDateString(112),
            endDate: getDateString(112)
          }
        }
      ],
      minorEvents: [
        {
          ...
          interestType: "culinary",
          dateRange: {
            startDate: getDateString(113),
            endDate: getDateString(113)
          },
        ...
        },
        {
          ...
          interestType: "localCulture",
          dateRange: {
            startDate: getDateString(114),
            endDate: getDateString(114)
          }
        }
      ]
    },
      ...
      keyEvents: [
        {
          ...
          interestType: "localCulture",
          dateRange: {
            startDate: getDateString(121),
            endDate: getDateString(121)
          },
        ...
        },
        {
          ...
          interestType: "concerts",
          dateRange: {
            startDate: getDateString(122),
            endDate: getDateString(122)
          }
        }
      ],
      minorEvents: [
        {
          ...
          interestType: "localCulture",
          dateRange: {
            startDate: getDateString(123),
            endDate: getDateString(123)
          },
        ...
        },
        {
          ...
          interestType: "culinary",
          dateRange: {
            startDate: getDateString(124),
            endDate: getDateString(124)
          }
        }
      ]
    },
    {
      ...
      dateRange: {
        startDate: getDateString(130),
        endDate: getDateString(135)
      },
      keyEvents: [
        {
          ...
          interestType: "concerts",
          dateRange: {
            startDate: getDateString(131),
            endDate: getDateString(131)
          },
        ...
        },
        {
          ...
          interestType: "localCulture",
          dateRange: {
            startDate: getDateString(132),
            endDate: getDateString(132)
          }
        }
      ],
      minorEvents: [
        {
          ...
          interestType: "culinary",
          dateRange: {
            startDate: getDateString(133),
            endDate: getDateString(133)
          },
        ...
        },
        {
          ...
          interestType: "artDesign",
          dateRange: {
            startDate: getDateString(134),
            endDate: getDateString(134)
          }
        }
      ]
    },
    {
      ...
      dateRange: {
        startDate: getDateString(140),
        endDate: getDateString(145)
      },
      keyEvents: [
        {
          ...
          interestType: "localCulture",
          dateRange: {
            startDate: getDateString(141),
            endDate: getDateString(141)
          },
        ...
        },
        {
          ...
          interestType: "concerts",
          dateRange: {
            startDate: getDateString(142),
            endDate: getDateString(142)
          }
        }
      ],
      minorEvents: [
        {
          ...
          interestType: "localCulture",
          dateRange: {
            startDate: getDateString(143),
            endDate: getDateString(143)
          },
        ...
        },
        {
          ...
          interestType: "culinary",
          dateRange: {
            startDate: getDateString(144),
            endDate: getDateString(144)
          }
        }
      ]
    },
    {
      ...
      city: "Dublin, Ireland",
      dateRange: {
        startDate: getDateString(150),
        endDate: getDateString(155)
      },
      keyEvents: [
        {
          ...
          interestType: "concerts",
          dateRange: {
            startDate: getDateString(151),
            endDate: getDateString(151)
          },
        ...
        },
        {
          ...
          interestType: "localCulture",
          dateRange: {
            startDate: getDateString(152),
            endDate: getDateString(152)
          }
        }
      ],
      minorEvents: [
        {
          ...
          interestType: "culinary",
          dateRange: {
            startDate: getDateString(153),
            endDate: getDateString(153)
          },
        ...
        },
        {
          ...
          interestType: "localCulture",
          dateRange: {
            startDate: getDateString(154),
            endDate: getDateString(154)
          }
        }
      ]
    },
    {
      ...
      city: "Vienna, Austria",
      dateRange: {
        startDate: getDateString(160),
        endDate: getDateString(165)
      },
      keyEvents: [
        {
          ...
          interestType: "concerts",
          dateRange: {
            startDate: getDateString(161),
            endDate: getDateString(161)
          },
        ...
        },
        {
          ...
          interestType: "localCulture",
          dateRange: {
            startDate: getDateString(162),
            endDate: getDateString(162)
          }
        }
      ],
      minorEvents: [
        {
          ...
          interestType: "culinary",
          dateRange: {
            startDate: getDateString(163),
            endDate: getDateString(163)
          },
        ...
        },
        {
          ...
          interestType: "artDesign",
          dateRange: {
            startDate: getDateString(164),
            endDate: getDateString(164)
          }
        }
      ]
    },
    {
      ...
      dateRange: {
        startDate: getDateString(170),
        endDate: getDateString(175)
      },
      keyEvents: [
        {
          ...
          interestType: "concerts",
          dateRange: {
            startDate: getDateString(171),
            endDate: getDateString(172)
          },
        ...
        },
        {
          ...
          interestType: "culinary",
          dateRange: {
            startDate: getDateString(173),
            endDate: getDateString(173)
          }
        }
      ],
      minorEvents: [
        {
          ...
          interestType: "localCulture",
          dateRange: {
            startDate: getDateString(174),
            endDate: getDateString(174)
          },
    ...
    },
    {
      ...
      dateRange: {
        startDate: getDateString(180),
        endDate: getDateString(185)
      },
      keyEvents: [
        {
        ...
        },
        {
          ...
          interestType: "localCulture",
          dateRange: {
            startDate: getDateString(182),
            endDate: getDateString(182)
          }
        }
      ],
      minorEvents: [
        {
          ...
          interestType: "culinary",
          dateRange: {
            startDate: getDateString(183),
            endDate: getDateString(183)
          },
        ...
        },
        {
          ...
          interestType: "localCulture",
          dateRange: {
            startDate: getDateString(184),
            endDate: getDateString(184)
          }
        }
      ]
    },
    {
      ...
      dateRange: {
        startDate: getDateString(190),
        endDate: getDateString(195)
      },
      keyEvents: [
        {
        ...
        },
        {
          ...
          interestType: "localCulture",
          dateRange: {
            startDate: getDateString(192),
            endDate: getDateString(192)
          }
        }
      ],
      minorEvents: [
        {
          ...
          interestType: "culinary",
          dateRange: {
            startDate: getDateString(193),
            endDate: getDateString(193)
          },
        ...
        },
        {
          ...
          interestType: "localCulture",
          dateRange: {
            startDate: getDateString(194),
            endDate: getDateString(194)
          }
        }
      ]
    },
      ...
      keyEvents: [
        {
          ...
          interestType: "concerts",
          dateRange: {
            startDate: getDateString(201),
            endDate: getDateString(201)
          },
        ...
        },
        {
          ...
          interestType: "localCulture",
          dateRange: {
            startDate: getDateString(202),
            endDate: getDateString(202)
          }
        }
      ],
      minorEvents: [
        {
          ...
          interestType: "culinary",
          dateRange: {
            startDate: getDateString(203),
            endDate: getDateString(203)
          },
        ...
        },
        {
          ...
          interestType: "localCulture",
          dateRange: {
            startDate: getDateString(204),
            endDate: getDateString(204)
          }
        }
      ]
    }
